...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ ᴜᴘᴅᴀᴛᴇᴢ ⚡", url="https://t.me/allnewmovieintime"), InlineKeyboardButton("⚡ sᴜᴘᴘᴏʀᴛ ⚡", url="https://t.me/OpusTechz")],
                    [InlineKeyboardButton("🎭 𝐁𝐨𝐭𝐳 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 🎭", url="https://t.me/allbotscollections"), InlineKeyboardButton("💠 ɢɪᴛʜᴜʙ 💠", url="https://github.com/Aadhi000")],
                    [InlineKeyboardButton("🎀 𝐌𝐨𝐯𝐢𝐞𝐬 𝐆𝐫𝐨𝐮𝐩 🎬", url="https://t.me/allnewmovieintime")]
                ]
            ),
...
async def help_handler(bot, message):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ ᴜᴘᴅᴀʏᴇᴢ ⚡", url="https://t.me/allnewmovieintime"), InlineKeyboardButton("⚡ sᴜᴘᴘᴏʀᴛ ⚡", url="https://t.me/OpusTechz")],
                [InlineKeyboardButton("🎭 𝐁𝐨𝐭𝐳 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 🎭", url="https://t.me/allbotscollections"), InlineKeyboardButton("💠 ɢɪᴛʜᴜʙ 💠", url="https://github.com/Aadhi000")],
                [InlineKeyboardButton("🎀 𝐌𝐨𝐯𝐢𝐞𝐬 𝐆𝐫𝐨𝐮𝐩 🎬  ", url="https://t.me/allnewmovieintimes")]
            ]
        )
    )
...
┃
┣⪼<b>ʙᴏᴛ ɴᴀᴍᴇ : <a href='https://github.com/Movieschannelofficials/File-To-Link/edit/main/Adarsh/bot/plugins/start_help.py'>ғɪʟᴇ ᴛᴏ ʟɪɴᴋ</a></b>
┣⪼<b>ᴜᴘᴅᴀᴛᴇᴢ : <a href='https://t.me/MWUpdatez'>ᴍᴡ ᴜᴘᴅᴀᴛᴇᴢ</a></b>
┣⪼<b>sᴜᴘᴘᴏʀᴛ : <a href='https://t.me/OpusTechz'>ᴏᴘᴜs ᴛᴇᴄʜᴢ</a></b>
┣⪼<b>sᴇʀᴠᴇʀ : ʜᴇʀᴜᴋᴏ</b>
┣⪼<b>ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ</b>
┣⪼<b>ʟᴀɴɢᴜᴀɢᴇ: ᴘʏᴛʜᴏɴ 3</b>
┣⪼<b>sᴏᴜʀᴄᴇ-ᴄᴏᴅᴇ : <a href='https://t.me/allbotscollections'>ғɪʟᴇ ᴛᴏ ʟɪɴᴋ</a></b>
┣⪼<b>𝐌𝐨𝐯𝐢𝐞𝐬 𝐆𝐫𝐨𝐮𝐩 : <a href='https://t.me/allnewmovieintimes'>ᴏᴘᴜs ᴛᴇᴄʜᴢ</a></b>
┃
<b>╰━━━━━━━〔ᴘʟᴇᴀsʀ sᴜᴘᴘᴏʀᴛ〕</b>""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ ᴜᴘᴅᴀᴛᴇᴢ ⚡", url="https://t.me/allnewmovieintime"), InlineKeyboardButton("💸 ᴅᴏɴᴀᴛᴇ 💸", url="https://paypal.me/114912Aadil")],
                [InlineKeyboardButton("🎀 𝐌𝐨𝐯𝐢𝐞𝐬 𝐆𝐫𝐨𝐮𝐩 🎬", url="https://t.me/allnewmovieintimes")]
            ]
        )
    )
